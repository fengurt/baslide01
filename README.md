...
| D09 侍天企业介绍 | `/decks/tiansight-corporate/` |
...
Numbers live in `decks.json`. Locate updates by **D01-D09**.
...
- **D09** `decks/tiansight-corporate/` — 侍天企业介绍，一页纸与 15 页 A4 企业介绍源文件的品牌校准优化版。
